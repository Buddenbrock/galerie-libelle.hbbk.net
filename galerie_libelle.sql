...
--
-- Host: localhost
-- Erstellungszeit: 22. Apr 2015 um 13:36
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1025032 ;
...
(1025030, 'Motivtasse', '15.50', 'img/exponate/1025030_produktbild.jpg', 0, 5, 'ewrfergzrtzhgrthrftgf', 1, '', 'weiß', NULL),
(1025031, 'Handyhüllen iPhone 5 und 5s', '26.84', 'img/exponate/1025031_produktbild.jpg', 12, 5, 'Handyhüllen mit verschiedensten Motiven.', 4, 'Passend für iPhone 5 und 5s', '', NULL);
...
CREATE TABLE IF NOT EXISTS `auftrag` (
  ...
  `auftragsdatum` text CHARACTER SET utf32 NOT NULL,
...
INSERT INTO `auftrag` (`auftragsnummer`, `auftragsdatum`, `kundennummer`) VALUES
(3, '21.04.2015', 1);
...
--
-- Daten für Tabelle `auftragspos`
--

INSERT INTO `auftragspos` (`auftragsnummer`, `artikelnummer`, `bestellmenge`, `bestellpreis`) VALUES
(3, 1025025, 1, '15,50');
...
INSERT INTO `kunden` (`kundennummer`, `username`, `password`, `vorname`, `nachname`, `adresse`, `plz`, `mail`) VALUES
(1, 'admin', 'admin', 'Dirk', 'Buddenbrock', 'Erzbischof-Buddenbrock-Straße 35', 45721, 'dirk-bu@arcor.de'),
(2, 'user', 'user', 'Markus', 'Buddenbrock', 'Erzbischof-Buddenbrock-Straße 35', 45721, 'dj.dirk@t-online.de');
